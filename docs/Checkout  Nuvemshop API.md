## Payment Options (Javascript Interface)[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#payment-options-javascript-interface "Direct link to Payment Options (Javascript Interface)")
...
Payment Options configuration params are set via our [Payment Provider API](https://tiendanube.github.io/api-documentation/resources/payment-provider) by adding [`checkout_payment_options`](https://tiendanube.github.io/api-documentation/resources/payment-provider#checkout-payment-options) on the Payment Provider object creation.
...
The file with the handlers implemented for the different options should be hosted on a CDN that must be capable of handling high traffic loads. The HTTPS URL to this file must be set in the [Payment Provider](https://tiendanube.github.io/api-documentation/resources/payment-provider) `checkout_js_url` property.

> Note: The file mentioned above must use data from method [`getData`](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#getdata) of Checkout Context. However, in case you need to use data stored in Local Storage, for example, you should [create a Script](https://tiendanube.github.io/api-documentation/resources/script) and use the method [postMessage](https://developer.mozilla.org/en-US/docs/Web/API/Window/postMessage) to send information stored in Local Storage from the store domain to Checkout's private domain. With this information inside the secure domain, the `checkout_js` file will be able to send it to your backend.

## Examples[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#examples "Direct link to Examples")

### External Payment Option[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#external-payment-option "Direct link to External Payment Option")

Let's take a look at a simple script for a hypothetical integration with a Payment Provider that redirects the consumer to _'acmepayments.com'_ to complete the purchase in their checkout. This is what we call a `redirect` checkout.
...
### Card Payment Option[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#card-payment-option "Direct link to Card Payment Option")
...
### Modal Payment Option[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#modal-payment-option "Direct link to Modal Payment Option")
...
##### Close modal button[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#close-modal-button "Direct link to Close modal button")

```
window.parent.postMessage({  type: "PAYMENT_MODAL_RESPONSE",  data: { success: true, closeModal: true }}, '*');
```

##### Failed payment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#failed-payment "Direct link to Failed payment")

```
window.parent.postMessage({  type: "PAYMENT_MODAL_RESPONSE",  data: { success: false, error_code: 'payment_processing_error' }}, '*');
```

##### Success payment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#success-payment "Direct link to Success payment")

```
window.parent.postMessage({  type: "PAYMENT_MODAL_RESPONSE",  data: { success: true }}, '*');
```

## Checkout Context[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#checkout-context "Direct link to Checkout Context")
...
| Name | Description |
| --- | --- |
| `http` | Method to perform AJAX requests. See [HTTP](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#http). |
| `utils` | Collection of helper functions. See [Utils](https://tiendanube.github.io/api-documentation/utils/postman-collections). |
...
| `setInstallments` | Update the attributes of the `data. installments` object. See [Installments](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#installments). |
| `getData` | Method to obtain the data of the shopping cart, the consumer and more. See [getData](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#getdata). |
| `processPayment` | Method to perform backend-to-backend processing of a payment request. See [processPayment](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#processpayment). |
| `showErrorCode` | Method to display an error message at the payment option form. See [showErrorCode](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#showerrorcode). |

### Checkout[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#checkout-1 "Direct link to Checkout")

#### HTTP[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#http "Direct link to HTTP")
...
##### Standard POST example[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#standard-post-example "Direct link to Standard POST example")
...
##### Custom config request example[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#custom-config-request-example "Direct link to Custom config request example")
...
#### Utils[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#utils "Direct link to Utils")

-   `Checkout.utils.Throttle`
-   `Checkout.utils.LoadScript`
-   `Checkout.utils.FlattenObject`

#### getData[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#getdata "Direct link to getData")
...
_Note:_ No all Payment Method Information fields are rendered. They can be rendered as explained [here](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#fields-property).
...
#### Legacy JS Integration[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#legacy-js-integration "Direct link to Legacy JS Integration")

The legacy JS integration is a way to make payment requests to the app's API directly from the JS script. Since this is currently deprecated, we only maintain its documentation for backward compatibility. For more information, see the [Process Payment API](https://tiendanube.github.io/api-documentation/guides/payment-provider#process-payment-api) specification.

##### External Payment Option Example `Deprecated`[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#external-payment-option-example-deprecated "Direct link to external-payment-option-example-deprecated")
...
##### Transparent Payment Option Example `Deprecated`[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#transparent-payment-option-example-deprecated "Direct link to transparent-payment-option-example-deprecated")
...
#### processPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#processpayment "Direct link to processPayment")

This method allows your app to process _backend-to-backend_ payment requests. As described in our [Payment Provider App Development Guide](https://tiendanube.github.io/api-documentation/guides/payment-provider#process-payment-api) documentation, for this use case our platform implements a generic payment payload that can be adapted to a specific payload that conforms to your app's API. But also, if necessary, this standard payload can be extended by adding custom data inside an `extra` object. The content of that `extra` object, which is optional, must be passed to the `processPayment` method as parameter.
...
#### showErrorCode[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#showerrorcode "Direct link to showErrorCode")

This method displays an error message for the consumer at the payment option form. It takes any value defined in our [error code library](https://tiendanube.github.io/api-documentation/resources/transaction#transaction-failure-codes) as a parameter, which will be translated into the corresponding error message according to the language used by the store.

```
LoadCheckoutPaymentContext(function(Checkout, PaymentMethods) {    var Custom = PaymentMethods.CustomPayment({        id: 'acme_custom',                onSubmit: function(callback) {            if (Checkout.getData('totalPrice') < 3) {                Checkout.showErrorCode('order_total_price_too_small');            }            ...        });    });
```

### PaymentOptions[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#paymentoptions "Direct link to PaymentOptions")
...
#### Transparent Integration Type[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#transparent-integration-type "Direct link to Transparent Integration Type")
...
##### CardPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#cardpayment "Direct link to CardPayment")
...
##### DebitPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#debitpayment "Direct link to DebitPayment")
...
##### BoletoPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#boletopayment "Direct link to BoletoPayment")
...
##### TicketPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#ticketpayment "Direct link to TicketPayment")
...
##### PixPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#pixpayment "Direct link to PixPayment")
...
#### PaymentOption Configuration Object and it's properties[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#paymentoption-configuration-object-and-its-properties "Direct link to PaymentOption Configuration Object and it's properties")
...
##### `fields` property[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#fields-property "Direct link to fields-property")
...
###### CreditPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#creditpayment "Direct link to CreditPayment")
...
###### DebitPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#debitpayment-1 "Direct link to DebitPayment")

| Name | Description |
| --- | --- |
| `bank_list` | Banks list. |

###### BoletoPayment[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#boletopayment-1 "Direct link to BoletoPayment")
...
###### For all payment options[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#for-all-payment-options "Direct link to For all payment options")
...
###### Updating the fields dynamically[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#updating-the-fields-dynamically "Direct link to Updating the fields dynamically")

```
Checkout.updateFields({  method: "acme_transparent_card",  value: {    bankId: true,  },});
```

##### onSubmit[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#onsubmit "Direct link to onSubmit")
...
In order to offer installment's options you must update the object `data.installments` by calling `setInstallments`. This will update the select input for the installments options on the card information form. Installments must be set considering the `min_installment_value` configured in [Payment Provider](https://tiendanube.github.io/api-documentation/resources/payment-provider#installments). The Merchant should be able to configure this field in the Partner's Backend.
...
##### Example[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#example "Direct link to Example")
...
### Checkout Runtime Error Codes[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#checkout-runtime-error-codes "Direct link to Checkout Runtime Error Codes")
...
All [Transaction Failure Codes](https://tiendanube.github.io/api-documentation/resources/transaction#transaction-failure-codes) are valid `error_codes`, in addition to those specified below:
...
### Remove payment option loading[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#remove-payment-option-loading "Direct link to Remove payment option loading")
...
### Checkout Captcha Information[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#checkout-captcha-information "Direct link to Checkout Captcha Information")
