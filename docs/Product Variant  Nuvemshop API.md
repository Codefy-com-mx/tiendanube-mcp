...
| image\_id | The id of the product's image associated with the variant |
| product\_id | The id of the product associated with the variant |
| price | Price of the Product Variant. _null_ indicates the product will initiate a contact instead of a checkout process |
| promotional\_price | Lower price to display as a sale. The value of price will be displayed crossed out for comparison |
| stock\_management | Specifies whether or not Tiendanube/Nuvemshop tracks the number of items in stock for this product variant. Valid values are _true_ if Tiendanube/Nuvemshop tracks the stock, _false_ if it doesn't. |
...
| age\_group | Attribute to set the demographic that the product is designed for. It is optional and only supports this values: "newborn", "infant", "toddler", "kids" and "adult". |
...
| created\_at | Date when the Product Variant was created in [ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601) |
| updated\_at | Date when the Product Variant was last updated in [ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601) |

## Endpoints[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#endpoints "Direct link to Endpoints")

### GET /products/{product\_id}/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#get-productsproduct_idvariants "Direct link to GET /products/{product_id}/variants")
...
| created\_at\_min | Show Product Variants created after date ([ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601)) |
| created\_at\_max | Show Product Variants created before date ([ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601)) |
| updated\_at\_min | Show Product Variants last updated after date ([ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601)) |
| updated\_at\_max | Show Product Variants last updated before date ([ISO 8601 format](http://en.wikipedia.org/wiki/ISO_8601)) |
| page | Page to show |
| per\_page | Amount of results |
| fields | Comma-separated list of fields to include in the response |

#### GET /products/1234/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#get-products1234variants "Direct link to GET /products/1234/variants")
...
#### GET /product/1234/variants?since\_id=105[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#get-product1234variantssince_id105 "Direct link to GET /product/1234/variants?since_id=105")
...
### GET /products/{product\_id}/variants/{id}[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#get-productsproduct_idvariantsid "Direct link to GET /products/{product_id}/variants/{id}")
...
#### GET /products/1234/variants/112[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#get-products1234variants112 "Direct link to GET /products/1234/variants/112")
...
### POST /products/{product\_id}/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#post-productsproduct_idvariants "Direct link to POST /products/{product_id}/variants")

Create a new Product Variant

#### POST /products/1234/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#post-products1234variants "Direct link to POST /products/1234/variants")
...
### PUT /products/{product\_id}/variants/{id}[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#put-productsproduct_idvariantsid "Direct link to PUT /products/{product_id}/variants/{id}")

Modify an existing Product Variant

#### PUT /products/1234/variants/144[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#put-products1234variants144 "Direct link to PUT /products/1234/variants/144")
...
### PUT /products/{product\_id}/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#put-productsproduct_idvariants "Direct link to PUT /products/{product_id}/variants")
...
#### PUT /products/1234/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#put-products1234variants "Direct link to PUT /products/1234/variants")
...
### PATCH /products/{product\_id}/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#patch-productsproduct_idvariants "Direct link to PATCH /products/{product_id}/variants")
...
#### Preconditions[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#preconditions "Direct link to Preconditions")
...
#### HTTP status code[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#http-status-code "Direct link to HTTP status code")

`200`: All `ProductVariant`s in the request have been updated. Complete updated `ProductVariant` collection is returned. `404`: `Product` with ID `\{product_id\}` was not found. `422`: Changes are not processable because some of the above preconditions has not been met.

#### PATCH /products/1234/variants[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#patch-products1234variants "Direct link to PATCH /products/1234/variants")
...
### DELETE /products/{product\_id}/variants/{id}[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#delete-productsproduct_idvariantsid "Direct link to DELETE /products/{product_id}/variants/{id}")

Remove a Product Variant

#### DELETE /products/1234/variants/112[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#delete-products1234variants112 "Direct link to DELETE /products/1234/variants/112")

`HTTP/1.1 200 OK`

### POST /products/{product\_id}/variants/stock[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#post-productsproduct_idvariantsstock "Direct link to POST /products/{product_id}/variants/stock")
...
#### POST /products/1234/variants/stock[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#post-products1234variantsstock "Direct link to POST /products/1234/variants/stock")
...
#### POST /products/1234/variants/stock[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#post-products1234variantsstock-1 "Direct link to POST /products/1234/variants/stock")
...
For products that have extra days that must be considered in the shipment (manufacturing, preparation), you can use our Metafields API. When creating the metafield with the number of additional days, the key **must be** sent as **additional\_days**, otherwise the days will not be considered. Payload example:
...
-   **Owner\_id**: Product variant identifier.

## Rate Limiting for Variant Updates[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#rate-limiting-for-variant-updates "Direct link to Rate Limiting for Variant Updates")
...
### Handling Rate Limits[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#handling-rate-limits "Direct link to Handling Rate Limits")

If your request exceeds the available tokens in the bucket, the API will respond with a `429 Too Many Requests` status code.

**Recommendation:** If you frequently encounter `429` errors during bulk updates, we recommend splitting your operations into smaller batches (sending fewer variants per request). This reduces the payload weight, requiring fewer tokens and helping you stay within the allowed limits.

## FAQ[](https://tiendanube.github.io/api-documentation/resources/abandoned-checkout#faq "Direct link to FAQ")

**How to set up unlimited/infinite stock?** **Why is the stock\_management property not being modified?**